...
(function initRandomSkin() {
  ...
  const CSS_RULES = `
    .skin-selection-item-information.loyalty-reward-icon--rewards.chud-random-flag-active {
  ...
  function createDiceButton() {
    ...
    button.className = `chud-random-dice-button ${diceButtonState}`;
  ...
  function updateDiceButton() {
    ...
    // Update button state
    diceButtonElement.className = `chud-random-dice-button ${diceButtonState}`;
  ...
  function updateRandomFlag() {
    ...
    if (randomModeActive) {
      ...
      element.classList.add("chud-random-flag-active");
  ...
  function hideFlagOnElement(element) {
    ...
    element.classList.remove("chud-random-flag-active");

    // Check if historic flag is active - if so, don't remove shared styles
    const hasHistoricFlag = element.classList.contains("chud-historic-flag-active");
