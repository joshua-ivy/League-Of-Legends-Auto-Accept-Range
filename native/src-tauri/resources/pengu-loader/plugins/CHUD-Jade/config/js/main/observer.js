      ...
      for (const obj of cb) {
        try {
          ...
          if (window.CHUDJadeLog) {
            window.CHUDJadeLog('error', 'Error in creation callback for id', { id: element.id, error: error.message || error })
          } else {
  ...
  if (cb != undefined) {
    for (const obj of cb) {
      try {
        ...
        if (window.CHUDJadeLog) {
          window.CHUDJadeLog('error', 'Error in creation callback for tag', { tag: tagLowered, error: error.message || error })
        } else {
      ...
      if (cb != undefined) {
        for (const obj of cb) {
          try {
            ...
            if (window.CHUDJadeLog) {
              window.CHUDJadeLog('error', 'Error in creation callback for class', { class: classLowered, error: error.message || error })
            } else {
