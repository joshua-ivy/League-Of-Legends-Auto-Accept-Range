(() => {
  const CONFIG = {
    API_URL: "https://plugins/CHUD-Jade/API/border.json",
  ...
  class RegaliaBorder {
    ...
    _applyRankedProfileSubtitle(selectedBorder) {
      ...
      try {
        ...
        // Prefer the chosen custom border tier (what you clicked in CHUD-Jade),
    ...
    async showBorderModal() {
      ...
      const logoUrl = 'https://plugins/CHUD-Jade/assets/logo.png';
